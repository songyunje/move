...
public class Test1 {
	public static void main(String[] args) throws IOException{
		// BufferedReader & BufferedWriter 가 더 빠른지!!
		
		// FileReader & FileWriter
		test1(" FileReader&Writer");
		
		
		// BufferedReadr & BufferedWriter
		test2("BufferReader&Writer");
	}
	...
	public static void test2(String testname) throws IOException {
		...
		BufferedWriter writer = new BufferedWriter((new FileWriter("big_input-copy2.txt")))){
			long start = System.nanoTime();
